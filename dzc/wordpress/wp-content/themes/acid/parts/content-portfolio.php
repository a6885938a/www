...
$project_gallery = Pure_Portfolio::get_images( $post->ID, array('pure_mini', 'large') );
			...
			<div class="flexslider purejs__slider--control">
					...
					<?php
						if ( !empty( $project_gallery ) ):
							...
							?>
								<li class="portfolio-image--large slide">
									<a class="popup-image" href="<?php echo $image['pure_mini']; ?>"><img src="<?php echo $image['pure_mini'] ?>" title="<?php the_title(); ?>" /></a>
								</li>
							<?php
							endforeach;
						endif;
