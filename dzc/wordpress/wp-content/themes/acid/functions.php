...
require( get_template_directory() . '/inc/lastest.php' );
...
function pure_scripts() {
	...
	wp_register_style( 'pure-social-icons', get_template_directory_uri() . '/css/social.css');
 ...
 * @param  (array) $args Arguments passed from Shortcode
...
/* -----------------------------------*/
function pure_pre_get_posts ( $query ) {
		...
		if ($total_pages > 1): ?>
			<div class="page-links">
				...
				echo paginate_links(array(  
				      ...
				      'total' => $total_pages, 
				      'type' => 'list',
				      'prev_text' => __("&larr;", "puremellow"),
				      'next_text' => __( "&rarr;", "puremellow" ),
				    )); 
			    ?>
			</div>
	<?php
...
add_action( 'pre_get_posts', 'pure_pre_get_posts' , 1);
...
if ( true === Pure::is_enabled( "colorbox", false ) ) {
	remove_action( "admin_menu", "pure_portfolio_meta" );	
}
