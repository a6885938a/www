...
function pure_required_plugins() {
	$plugin_directory = get_template_directory() . "/assets/plugins/";
	...
	$plugins = array(
		...
		array(
			'name'     				=> 'Pure Portfolio',
			'slug'     				=> 'pure-portfolio', 
			'source'   				=> $plugin_directory . 'pure-portfolio.zip', 
			'required' 				=> false, 
			'version' 				=> '1.1.1', 
		...
		array(
			...
			'source'   				=> $plugin_directory . 'pure-shortcodes.zip', 
			'required' 				=> true, 
			'version' 				=> '1.0.3', 
		...
		array(
			'name'     				=> 'Pure Social Icons', 
			'slug'     				=> 'pure-social-icons', 
			'source'   				=> $plugin_directory . 'pure-social-icons.zip', 
			'required' 				=> false, 
			'version' 				=> '', 
			'force_activation' 		=> false, 
			'force_deactivation' 	=> false, 
